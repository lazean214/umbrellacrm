...
@php
    ...
    $cacheKey = 'kanban_deals_' . md5(json_encode([
        $this->filterDealName,
        $this->filterOwner,
        $this->filterContact,
...
>
    ...
    <template x-for="stage in stages" :key="stage">
        <div
            ...
            x-on:drop.prevent="canEditStage(stage) && onDrop($event, stage)"
        >
            ...
            <div
                :id="'kanban-col-' + stage"
                class="flex-1 overflow-y-auto p-2 md:p-3 space-y-2"
            >
                ...
                <template x-for="deal in getDealsByStage(stage)" :key="deal.id">
                    ...
                    >
                        ...
                        <div
                            class="relative bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700
                        ...
                        >
                            ...
                            {{-- Drag handle --}}
                            <div class="text-slate-300 dark:text-slate-600 group-hover:text-slate-500
                                        dark:group-hover:text-slate-400 transition text-sm pt-0.5 select-none shrink-0">⠿</div>
                                    ...
                                    <template x-if="deal.companies && deal.companies[0]">
                                        <div class="flex items-center gap-1.5">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" fill="currentColor">
                                                ...
                                                <path fill="currentColor" d="M19 3v18h-6v-3.5h-2V21H5V3zm-4 4h2V5h-2zm-4 0h2V5h-2zM7 7h2V5H7zm8 4h2V9h-2zm-4 0h2V9h-2zm-4 0h2V9H7zm8 4h2v-2h-2zm-4 0h2v-2h-2zm-4 0h2v-2H7zm8 4h2v-2h-2zm-8 0h2v-2H7zM21 1H3v22h18z"/>
                                            </svg>
 ...
 */
function kanbanBoard({ livewireDeals, stages, stageConfig, cacheKey, isSalesUser, editableStages }) {
    ...
    return {
        ...
        init() {
            ...
            this.$wire.on('kanban-deals-updated', ({ deals: fresh }) => {
