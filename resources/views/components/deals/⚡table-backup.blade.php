                ...
                >
                    ...
                    <div class="flex-1 min-w-0 pl-1">
                        ...
                        <div class="space-y-1.5 text-xs text-slate-500 dark:text-slate-400">
                            ...
                            <div class="flex items-center gap-1.5">
                                <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" title="Company" fill="currentColor">
            ...
            <table class="w-full border-collapse text-left text-sm">
                <thead>
                    <tr class="bg-slate-50 dark:bg-slate-800/60 border-b border-slate-200 dark:border-slate-800">
                        ...
                        <th class="px-5 py-3.5 font-semibold text-xs text-slate-500 dark:text-slate-400 uppercase tracking-wider">Deal Owner</th>
